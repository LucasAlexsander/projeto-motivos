                    ...
                    <div class="table-responsive">
                        <div class="button-absolute"> <!-- Botão para adicionar  -->
                            <div class="button-absolute-text">
                                <a href="admin/add/cessacao">[ Adicionar Registro ]</a>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icons-area">
                                                <a href="admin/edit/{{$cessacaoItem->id_cessacao}}/cessacao"><img src="/assets/images/icons/create-outline.svg"></img></a>
                                                <a href="admin/delete/{{$cessacaoItem->id_cessacao}}/cessacao" onclick="return confirm('Deseja excluir?')"><img src="/assets/images/icons/trash-outline.svg"></img></a>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <div class="button-absolute">
                            <div class="button-absolute-text">
                                <a href="admin/add/reativacao">[ Adicionar Registro ]</a>
                            </div>
                            </div>
                        <table class="listar_dados table table-striped table-bordered" style="width: 100%;">
                            <thead>
                            ...
                            <tbody>
                                ...
                                @foreach ($reativacao as $reativacao)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icons-area">
                                                <a href="admin/edit/{{$reativacao->id_reativacao}}/reativacao"><img src="/assets/images/icons/create-outline.svg"></img></a>
                                                <a href="admin/delete/{{$reativacao->id_reativacao}}/reativacao" onclick="return confirm('Deseja excluir?')"><img src="/assets/images/icons/trash-outline.svg"></img></a>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <div class="button-absolute">
                            <div class="button-absolute-text">
                                <a href="admin/add/suspensao">[ Adicionar Registro ]</a>
                            </div>
                        </div>
                        <table class="listar_dados table table-striped table-bordered" style="width: 100%;">
                            <thead>
                            ...
                            <tbody>
                                ...
                                @foreach ($suspensao as $suspensaoItem)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icons-area">
                                                <a href="admin/edit/{{$suspensaoItem->id_suspensao}}/suspensao"><img src="/assets/images/icons/create-outline.svg"></img></a>
                                                <a href="admin/delete/{{$suspensaoItem->id_suspensao}}/suspensao" onclick="return confirm('Deseja excluir?')"><img src="/assets/images/icons/trash-outline.svg"></img></a>
                                            </div>
                                        </td>
                                    </tr>
