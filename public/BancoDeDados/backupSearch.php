					...
					<div class="col-md-12">
					  <nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							...
							echo '" id="nav-home-tab" data-toggle="tab" href="#nav-PRISMA" role="tab" aria-controls="nav-home" aria-selected="true">PRISMA/SABI/SIBE PU</a>
							<a class="nav-item nav-link ';
							if($linha['reatnb_plenus'] != null){ if($linha['prisma_sabi'] == null) { echo "active"; }} else { echo "disabled";}
							echo '" id="nav-profile-tab" data-toggle="tab" href="#nav-REATNB" role="tab" aria-controls="nav-profile" aria-selected="false">REATNB/SIBE PU</a>
						</div>
					  </nav>
